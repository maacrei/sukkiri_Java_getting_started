...
public class Ans_event {
	public static void main(String[] args) {
		...
		System.out.println("イベントポイント報酬 〜目標ノルマ計算プログラム〜");
...
//		if (point != noruma(firstDayPoints, secondDayPoints, thirdDayPoints,
//				fourthDayPoints, fifthDayPoints, sixthDayPoints, seventhDayPoints)) {
//
//
//		}
		System.out.println("ノルマ合計！");
		System.out.println(firstDayPoints(point) + secondDayPoints(point) + thirdDayPoints(point) + fourthDayPoints(point)
		                   + fifthDayPoints(point) + sixthDayPoints(point) + seventhDayPoints(point));
//		noruma(firstDayPoints, secondDayPoints, thirdDayPoints,
//				fourthDayPoints, fifthDayPoints, sixthDayPoints, seventhDayPoints);
	...
	public static int noruma(int firstDayPoints, int secondDayPoints, int thirdDayPoints,
			int fourthDayPoints, int fifthDayPoints, int sixthDayPoints, int seventhDayPoints) {
		int norumaTotal = firstDayPoints + secondDayPoints + thirdDayPoints + fourthDayPoints
        + fifthDayPoints + sixthDayPoints + seventhDayPoints;
		return norumaTotal;
	}
}
